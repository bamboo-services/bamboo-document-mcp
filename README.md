...
| 平台 | 插件包 | 说明 |
|------|--------|------|
| macOS Apple Silicon | `document-macos-aarch` | M1/M2/M3 芯片 |
| macOS Intel | `document-macos-amd` | Intel 芯片 |
| Linux ARM64 | `document-linux-aarch` | ARM 服务器 |
| Linux AMD64 | `document-linux-amd` | x86_64 服务器 |
| Windows AMD64 | `document-windows-amd` | 64 位 Windows |
